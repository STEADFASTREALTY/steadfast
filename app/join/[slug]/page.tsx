...
export default async function JoinBrokeragePage({ params, searchParams }: { params: Promise<{ slug: string }>; searchParams: Promise<{ error?: string; notice?: string }> }) {
  ...
  return <main className="account-page">
    <AccountHeader displayName={account.person.display_name} hasWorkspace={Boolean(context.membership)} canManageAgents={false} canManageListings={false} canManageInquiries={false} canShareListings={false} />
