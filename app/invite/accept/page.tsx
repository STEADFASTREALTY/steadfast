...
export const metadata: Metadata = { title: "Accept invitation", description: "Accept a private invitation to join a SteadFast brokerage.", robots: { index: false, follow: false } };
